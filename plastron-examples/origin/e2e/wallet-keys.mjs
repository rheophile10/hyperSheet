...
await call("wallet.unlock", null, { type:"change", target:{ value:"pw" } });
await call("setValue", "wallet.newName", "anthropic");
await call("wallet.setNamed", null, { type:"change", target:{ value:"sk-ant-1" } });
await page.waitForTimeout(300);
let kc = await keyc();
...
await call("setValue", "wallet.newName", "openai");
await call("wallet.setNamed", null, { type:"change", target:{ value:"sk-oai-2" } });
await page.waitForTimeout(300);
kc = await keyc();
