...
cp ~/projects/wasm-factory/dist/doom.wasm \
   ~/projects/plastron/plastron-examples/doom/doom.wasm
```
...
cd ~/projects/plastron/plastron-examples/doom
...
- `kind:"wasm"` loader:
  `../../plastron/docs/4-current/07-wasm/11-wasm-bytes-kind.md`
- Host-instance hook:
  `../../plastron/docs/4-current/07-wasm/12-wasm-host-instance.md`
- Roadmap: `../../plastron/docs/2-roadmap/parallel/doom-wasm-build.md`
