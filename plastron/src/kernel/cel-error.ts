import type { Fn, Key, State, ValueCel } from "../types/index.js";

// ============================================================================
// cel-error — trap-as-value error machinery (kernel-resident).
//
...
// cels — symmetric with everything in js-common-schema. The schema cel and
// its protocol fns are seeded by the kernel SEGMENT (甲骨坑/kernel);
// this module carries only the trap-as-value MACHINERY the kernel's own
// modules (runCycle, precompute, hydrate) import directly.
// ============================================================================
 ...
 *  Schema in the kernel segment's cel-error.甲骨.json; this type
 *  co-locates the shape for ergonomics inside kernel code that
 *  constructs error values. Keep the two in sync.
 *
